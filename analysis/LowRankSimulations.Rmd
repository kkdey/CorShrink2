...
```{r}
out = CorShrinkDataNuclear(data_with_missing, stepsize = 1e-05, alpha = 1, max_iter = 100, tol = 1e-05)
...
```{r}
out = CorShrinkDataNuclear(data_with_missing, stepsize = 1e-5, alpha = 1, max_iter = 100, tol = 1e-05)
plot(svd(out$estS)$d, pch = 20)
```
